<template>
    <div>
                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-4 form-group">
                            <input type="text" placeholder="Matter Reference" name="matterRef" v-model="order.matterRef" class="form-control">
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-4 form-group">
                            <input class="form-control" name="titleRef" v-model="order.titleRef" value="" placeholder="Title Reference">
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 form-group">
                            <input class="form-control form-group" name="address" v-model="order.address" value="" placeholder="Address Search">
                        </div>
                        <div class="col-md-2 form-group">
                            <br>
                            <a class="linkanc vmid" v-on:click.prevent="verifyAddress" href="">Verify Address</a>
                        </div>
                        <div class="col-md-6 col-md-offset-0"  v-if="verifyAddrressSuccess">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group">
                            <button class="material-button-raised" @click.prevent="createOrder">
                                Submit
                            </button>
                        </div>
                    </div>
        ...
        <div class="container" v-if="createOrderSuccess">
            <div class="col-md-8 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h5>Order created sucessfully with below information</h5>
                    </div>
                    <div class="panel-body">
                        <p>Order Id: </p>
...
export default {
  data() {
    return {
      verifyTitleRefSuccess: true,
      verifyAddrressSuccess: true,
